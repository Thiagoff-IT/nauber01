    ...
    <div className="contato-div2">
      <div className="footer-div4">
        <div className="footer-div5">
          ...
          <img className="phone-icon11" alt="" src="../phone11.svg" />
          ...
          <img className="pin-icon2" alt="" src="../pin1.svg" />
      ...
      <div className="header-div2">
        <div className="bg-header7" />
        <div className="bg-header8" />
        <div className="bg-header9" />
        <div className="logo-div2">
          <img
            className="nauber-logo-1-icon2"
            alt=""
            src="../nauberlogo-1@2x.png"
          />
          <img
            className="logo-nauber-12"
            alt=""
            src="../logo-nauber-1@2x.png"
          />
        </div>
        <div className="menu-div2">
          <img className="vector-icon18" alt="" src="../vector-83.svg" />
          <div className="home-div3">
            <b className="home-b2">HOME</b>
            <img className="home-icon2" alt="" src="../home2.svg" />
          </div>
          <div className="empresa-div2">
            <img className="empresa-icon2" alt="" src="../empresa.svg" />
            <b className="empresa-b2">EMPRESA</b>
          </div>
          <div className="produtos-div9">
            <b className="produtos-b2">PRODUTOS</b>
            <img className="box-icon2" alt="" src="../box2.svg" />
          </div>
          <div className="assistencia-div2">
            <b className="assistncias-b3">ASSISTÊNCIAS</b>
            <img className="home-icon2" alt="" src="../assistencias2.svg" />
          </div>
          <div className="catlogos-div2">
            <b className="catlogos-virtuais-b2">CATÁLOGOS VIRTUAIS</b>
            <img className="home-icon2" alt="" src="../catalagos1.svg" />
          </div>
          <div className="contato-div3">
            <b className="contato-b2">CONTATO</b>
            <img className="home-icon2" alt="" src="../contato2.svg" />
          </div>
          <div className="login-div2">
            <b className="login-b2">login</b>
            <img className="logim-icon2" alt="" src="../logim.svg" />
          </div>
        </div>
        <div className="flags-div2">
          <img className="vector-icon19" alt="" />
          <img
            className="flag-brasil-1-icon2"
            alt=""
            src="../flagbrasil-12@2x.png"
          />
          <img
            className="flag-espanha-1-icon2"
            alt=""
            src="../flagespanha-1@2x.png"
          />
          <img className="flag-eua-1-icon2" alt="" src="../flageua-1@2x.png" />
          <img
            className="flag-arabia-1-icon2"
            alt=""
        ...
        <img
          className="base-de-conhecimento-12"
          alt=""
          src="../base-de-conhecimento-1@2x.png"
        />
        <img
          className="logo-revenda-pro-12"
          alt=""
          src="../logo-revenda-pro-1@2x.png"
        />
        <div className="conhea-o-sistema-de-revnda-n2">
          <p className="rua-mal-castelo2">
            <span className="conhea-o-sistema5">
          ...
          <p className="nauber-pro3">
            <span>
              <b>NAUBER PRO</b>
            </span>
          </p>
        </div>
        <div className="seach-div2">
          <div className="rectangle-div54" />
          <img className="frame-icon1" alt="" src="../frame-2.svg" />
        </div>
      </div>
      <div className="headline-div1">
        <img className="vector-icon20" alt="" src="../vector-1171.svg" />
        <img className="vector-icon21" alt="" src="../vector-1161.svg" />
      ...
      <div className="telefone-div">
        ...
        <img className="logo-whast-icon" alt="" src="../logo-whast.svg" />
      </div>
      ...
      <div className="contatos-rpidos-div">
        ...
        <img className="icones-redes" alt="" src="../icones-redes.svg" />
        <img className="whatsapp-icon" alt="" src="../whatsapp.svg" />
        <img className="mail-icon" alt="" src="../mail.svg" />
        <img className="pin-icon3" alt="" src="../pin3.svg" />
        <img className="phone-icon12" alt="" src="../phone12.svg" />
      ...
      <div className="form-div2">
        ...
        <img className="rectangle-icon" alt="" src="../rectangle-152.svg" />
        ...
        <div className="digite-seu-nome">Digite seu nome</div>
        ...
        <img className="vector-icon22" alt="" src="../vector-122.svg" />
      </div>
      <div className="busque-aqui-seu-produto2">busque aqui seu produto</div>
    </div>
  );
};
